  ...
  constructor(props) {
    ...
    this.state = {
      todos: [
        {
          id: 1,
          task: "Send invoice with number #212A23",
          isCompleted: true,
        },
        {
          id: 2,
                      ...
                      <div>
                        ...
                        <form className="add-items d-flex" onSubmit={this.addTodo}>
                          <input
                            ...
                            required
                          />
                          <button type="submit" className="btn btn-gradient-primary font-weight-bold">
                            <Trans>Add</Trans>
                          </button>
                        </form>
            ...
            <Tab eventKey="CHATS" title="CHATS">
              <div>
                ...
                <ul className="chat-list">
                  ...
                  <li className="list">
                    <div className="profile">
                      <img src={require("../../assets/images/faces/face5.jpg")} alt="profile" />
                      <span className="online"></span>
                    </div>
                    <div className="info">
                      <p>
    ...
    <li className={props.isCompleted ? "completed" : null}>
      <div className="form-check">
        <label htmlFor="" className="form-check-label">
          <input className="checkbox" type="checkbox" checked={props.isCompleted} onChange={props.changed} /> {props.children}{" "}
